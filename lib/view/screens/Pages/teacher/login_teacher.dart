...
import 'package:e_learning/view/screens/Pages/teacher/register.dart';
...
class _Teacher_LoginState extends State<Teacher_Login> {
  ...
  void _loginUser() async {
    ApiResponse response = await login(txtteacherEmail.text, txtteacherPassword.text);
              ...
              children: [
               ...
               const  SizedBox(
                ...
                kLoginRegisterHint('Dont have an acount? ', 'Register', () {
                  Navigator.of(context).pushAndRemoveUntil(
                      MaterialPageRoute(builder: (context) =>  Teacher_Register()),
                      (route) => false);
                })
              ],
            ),
