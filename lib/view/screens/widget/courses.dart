            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      const Icon(Icons.schedule_rounded, color: labelColor, size: 14,), 
                      const SizedBox(width: 2,),
                      Text(data["duration"], style: const TextStyle(fontSize: 12, color: labelColor),),
                      const SizedBox(width: 20,),
                      const Icon(Icons.star, color: orange, size: 14,), 
                      const SizedBox(width: 2,),
                      Text(data["review"], style: const TextStyle(fontSize: 12, color: labelColor),)
                    ],
                  )
                ],
              )
